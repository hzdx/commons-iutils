...
public class SftpClient implements Closeable{
	...
	public static void main(String[] args) throws Exception {
		// String url = "sftp[pass:true,aa1:sdb,aa2:sdc,aa3:sdd]://asdf:aa@#$@10.221.247.27:2342/q/a/b/bb/c";
		// String url = "ftp://dxpanalysis:dxpanalysis@123@10.11.27.19/20161108/10/gn/dns/";
		//String url = "sftp://ipms:SHms!50*@10.221.247.50/home/ipms/shpm-service/shpm-schedule/logs/debug.log.3";
		String url = "sftp://nettest:nettest!^*@10.11.60.159/data/Flux_00_201611132150_10.11.60.159_000.AVL";
		if(args != null && args[0] != null) url = args[0];
		...
		client.close();
		//测试程序 java -Djava.ext.dirs=../lib:${JAVA_HOME}/jre/lib/ext -classpath shpm-task-v1.1-20161114.jar com.eastcom.pm.manager.common.io.SftpClient 'sftp://nettest:nettest!^*@10.11.60.159/data/Flux_00_201611132150_10.11.60.159_000.AVL'
